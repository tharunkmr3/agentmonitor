...
export interface RunOptions {
  ...
  addDirs?: string[]
  /** Files/images to include as content blocks */
  attachments?: RunAttachment[]
  /** Path to MCP config JSON for --mcp-config */
...
export const IPC = {
  ...
  // ─── Codex (fully separate) ───
  CODEX_CREATE_TAB: 'codex:create-tab',
  CODEX_PROMPT: 'codex:prompt',
  CODEX_STOP_TAB: 'codex:stop-tab',
  CODEX_CLOSE_TAB: 'codex:close-tab',
  CODEX_CHECK: 'codex:check',
} as const
